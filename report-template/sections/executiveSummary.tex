\begin{cvletter}
   ...
   \begin{minipage}[t]{0.33\textwidth} 
      ...
      \begin{tabular}{c|ll}
         ...
         \hline
         \color{awesome-red}
         \Huge{\textbf{4}}	     & \large{\textsc{\textbf{\color{darktext}{Alto}}}}& 7.0--8.9\\
         \hline
         \color{awesome-orange}
         \Huge{\textbf{2}}	     & \large{\textsc{\textbf{\color{lightgray}{Medio}}}} & 4.0--6.9\\
         \hline
         \color{awesome-emerald}
         \Huge{\textbf{13}}	     & \large{\textsc{\color{lightgray}{Basso}}} & 0.1--3.9\\
         \hline
         \color{awesome-skyblue}
         \Huge{123}	     & \normalsize{\textsc{Info}} & 0.0\\
      \end{tabular}

      %% TORTA
      \begin{tikzpicture}
         \pie[hide number,explode=0.1,text=inside, scale font, radius=2.5, color={black!90,awesome-red!90,awesome-orange!90,awesome-emerald!90}]{24/\color{white}Critico, 16/\color{white}Alto, 8/\color{white}Medio, 52/\color{white}Basso}
      \end{tikzpicture}

      \footnotesize
      \subsection{Legenda}
      \textsc{\color{black}{\textbf{Critico}}}: Vulnerabilità facilmente sfruttabili la cui compromissione permette di avere accesso completo
      al sistema. Si consiglia di prendere provvedimenti immediati.\\

      \textsc{\color{awesome-red}{\textbf{Alto}}}: Vulnerabilità il cui sfruttamento è più difficile ma possono comunque causare
      ...
      \textsc{\color{awesome-emerald}{\textbf{Basso}}}: Vulnerabilità non sfruttabili o non particolarmente dannose, la loro
